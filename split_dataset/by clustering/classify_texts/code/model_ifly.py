...
# datas = load_data("../IFLYTEK/train.json")
# random.shuffle(datas)

# train_data = [d for i, d in enumerate(datas) if i % 10 != 0]
# valid_data = [d for i, d in enumerate(datas) if i % 10 == 0]

train_data = load_data("../../split_data/IFLYTEK/train_data.json")
valid_data = load_data("../../split_data/IFLYTEK/test_data.json")
...
if __name__ == '__main__':
    ...
    category = set()
    test_datas = load_data("../IFLYTEK/dev.json")
